...
import { ChevronDown, ChevronRight, FileText, MessageSquare, Wrench, Paperclip, Cpu, Clock } from "lucide-react"
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
/**
 * Progress bar component for token utilization
 */
export const UtilizationBar = ({ percent, className }: { percent: number; className?: string }) => {
...
interface ChatContextDialogContentProps {
  workspaceId: string
  chatId?: string
  open: boolean
...
/**
 * Controlled context dialog that displays AI context information
 * including summary, system prompt, history, tools, and attachments.
 */
export function ChatContextDialogContent({ workspaceId, chatId, open, onOpenChange }: ChatContextDialogContentProps) {
